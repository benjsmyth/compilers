...
* Operation Expression
 17:   LDC 0, 1(0)	* load int into register 0
...
* Assign Expression
 ...
 48:    ST 0, -4(5)	* store simplevar
 49:    ST 5, -5(5)	* Push original frame pointer
 50:   LDA 5, -5(5)	* Push original frame
 51:   LDA 0, 1(7)	* Load data with return pointer
 52:   LDA 7, -41(7)	* Jump to function
 53:    LD 5, 0(5)	* Pop frame
 54:    ST 0, -5(5)	* store return value
 55:    LD 0, -4(5)	* load leftside into reg 0
 56:    LD 1, -5(5)	* load rightside into reg 1
 57:    ST 1, 0(0)	* store into var
 58:    ST 1, -3(5)	* store into assign expression
 59:    LD 0, -5(5)	* 
 60:   OUT 0, 0, 0	* output
* RETURN
 61:    LD 0, -5(5)	* load return value
 62:    LD 7, -1(5)	* Return to caller
 45:   LDA 7, 17(7)	* jump around function
* FINALE
 63:    ST 5, 0(5)	* Push original frame pointer
 64:   LDA 5, 0(5)	* Push original frame
 65:   LDA 0, 1(7)	* Load data with return pointer
 66:   LDA 7, -21(7)	* Jump to main
